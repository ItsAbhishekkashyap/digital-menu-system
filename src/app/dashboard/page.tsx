...
//                                         variant="ghost" 
//                                         size="icon" 
//                                         className="text-gray-400 hover:text-white hover:bg-gray-700/50 -mt-2 -mr-2"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {restaurants.map((restaurant) => (
                        <div key={restaurant.id} className="feature-card rounded-xl p-5 flex flex-col h-full group">
                            ...
                            {/* Card Header: Image + Title + Settings */}
                            <div className="flex items-start gap-4 relative">
                                ...
                                {/* Settings Icon - Absolute top right for larger touch target */}
                                <Button 
                                    variant="ghost" 
                                    size="icon" 
                            ...
                            {/* Actions Footer - Stacked on Mobile, Side-by-Side on Desktop */}
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-auto">
                                <Button 
                                    variant="outline"
